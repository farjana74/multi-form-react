...
import "./FourthSignUpForm.css";
import AOS from 'aos';
import 'aos/dist/aos.css';
import React, { useState, useEffect } from 'react';

const FourthSignUpForm = ({ formData, setFormData, content, setContent, contents, setContents, contentDiscussion, setContentDiscussion, contentParticipant, setContentParticipant, page, setPage, FormTitles }) => {
        ...
        <div className='container py-5'>
            <div className="row pt-5 align-items-center justify-content-between ">
                <div className='col-12 col-sm-12 col-md-12 col-lg-6'>
                    ...
                    <h1 className='secondSignUp-title pb-2'>Enter Your Address
                    </h1>
                    <h6 className='text-white pb-4'>To play in contests, we're required to verify your location.</h6>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div class="mb-3">
                            ...
                            <label for="exampleFormControlInput1" class="form-label text-white fs-6">PHYSICAL ADDRESS</label>
...
export default FourthSignUpForm;